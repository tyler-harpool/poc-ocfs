...
pub struct UpdateJudge {
    ...
    pub recess_appointment_date_1: Option<String>,
    pub nomination_date_1: Option<String>,
    pub committee_referral_date_1: Option<String>,
    pub hearing_date_1: Option<String>,
    pub judiciary_committee_action_1: Option<String>,
    pub committee_action_date_1: Option<String>,
    pub senate_vote_type_1: Option<String>,
    pub ayes_nays_1: Option<String>,
    pub confirmation_date_1: Option<String>,
    pub commission_date_1: Option<String>,
    ...
    pub senior_status_date_1: Option<String>,
    pub termination_1: Option<String>,
    pub termination_date_1: Option<String>,
    ...
    pub recess_appointment_date_2: Option<String>,
    pub nomination_date_2: Option<String>,
    pub committee_referral_date_2: Option<String>,
    pub hearing_date_2: Option<String>,
    pub judiciary_committee_action_2: Option<String>,
    pub committee_action_date_2: Option<String>,
    pub senate_vote_type_2: Option<String>,
    pub ayes_nays_2: Option<String>,
    pub confirmation_date_2: Option<String>,
    pub commission_date_2: Option<String>,
    ...
    pub senior_status_date_2: Option<String>,
    pub termination_2: Option<String>,
    pub termination_date_2: Option<String>,
    ...
    pub recess_appointment_date_3: Option<String>,
    pub nomination_date_3: Option<String>,
    pub committee_referral_date_3: Option<String>,
    pub hearing_date_3: Option<String>,
    pub judiciary_committee_action_3: Option<String>,
    pub committee_action_date_3: Option<String>,
    pub senate_vote_type_3: Option<String>,
    pub ayes_nays_3: Option<String>,
    pub confirmation_date_3: Option<String>,
    ...
    pub senior_status_date_3: Option<String>,
    pub termination_3: Option<String>,
    pub termination_date_3: Option<String>,
    ...
    pub recess_appointment_date_4: Option<String>,
    pub nomination_date_4: Option<String>,
    pub committee_referral_date_4: Option<String>,
    pub hearing_date_4: Option<String>,
    pub judiciary_committee_action_4: Option<String>,
    pub committee_action_date_4: Option<String>,
    pub senate_vote_type_4: Option<String>,
    pub ayes_nays_4: Option<String>,
    pub confirmation_date_4: Option<String>,
    pub commission_date_4: Option<String>,
    pub service_as_chief_judge_begin_4: Option<i32>,
    pub service_as_chief_judge_end_4: Option<i32>,
    pub second_service_as_chief_judge_begin_4: Option<String>,
    pub second_service_as_chief_judge_end_4: Option<String>,
    pub senior_status_date_4: Option<String>,
    pub termination_4: Option<String>,
    pub termination_date_4: Option<String>,
    ...
    pub recess_appointment_date_5: Option<String>,
    pub nomination_date_5: Option<String>,
    pub committee_referral_date_5: Option<String>,
    pub hearing_date_5: Option<String>,
    pub judiciary_committee_action_5: Option<String>,
    pub committee_action_date_5: Option<String>,
    pub senate_vote_type_5: Option<String>,
    pub ayes_nays_5: Option<String>,
    pub confirmation_date_5: Option<String>,
    pub commission_date_5: Option<String>,
    pub service_as_chief_judge_begin_5: Option<i32>,
    pub service_as_chief_judge_end_5: Option<i32>,
    pub second_service_as_chief_judge_begin_5: Option<String>,
    pub second_service_as_chief_judge_end_5: Option<String>,
    pub senior_status_date_5: Option<String>,
    pub termination_5: Option<String>,
    pub termination_date_5: Option<String>,
    ...
    pub recess_appointment_date_6: Option<String>,
    pub nomination_date_6: Option<String>,
    pub committee_referral_date_6: Option<String>,
    pub hearing_date_6: Option<String>,
    pub judiciary_committee_action_6: Option<String>,
    pub committee_action_date_6: Option<String>,
    pub senate_vote_type_6: Option<String>,
    pub ayes_nays_6: Option<String>,
    pub confirmation_date_6: Option<String>,
    pub commission_date_6: Option<String>,
    pub service_as_chief_judge_begin_6: Option<String>,
    pub service_as_chief_judge_end_6: Option<String>,
    pub second_service_as_chief_judge_begin_6: Option<String>,
    pub second_service_as_chief_judge_end_6: Option<String>,
    pub senior_status_date_6: Option<String>,
    pub termination_6: Option<String>,
    pub termination_date_6: Option<String>,
