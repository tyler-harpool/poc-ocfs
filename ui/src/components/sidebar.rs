...
pub fn Sidebar() -> impl IntoView {
    ...
    view! {
        ...
        <div class="p-4 text-center">
            <h2 href="localhost:3000" class="text-2xl font-semibold ">Home</h2>
        </div>
        <div class="p-4 rounded-lg shadow-lg w-full max-w-4xl mx-auto">
        <nav class="flex flex-col space-y-4 text-white text-sm">
            <a href="/dashboard/overview" class="flex items-center text-gray-400 hover:text-white">
            ...
            <a href="/participants" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 8h10M7 12h10M7 16h10M5 6v14m14-14v14M3 4h18"></path>
                </svg>
                "Cases"
            </a>
            <a href="documents/activity" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 4h16v16H4z"></path>
                </svg>
                "Documents"
            </a>
            <a href="/scheduling/activity" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/reports/activity" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/user-management" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 7h18M5 10v10h14V10M9 15h6"></path>
                </svg>
                "User Management"
            </a>
            <a href="/support" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
            ...
            <a href="/changelog" class="flex items-center text-gray-400 hover:text-white">
                <svg class="w-6 h-6 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
